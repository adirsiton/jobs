...
INSERT INTO jobs.roles(name, tag, color) VALUES 
    ('תוכניתן', 'DEV','#7030A0'),
    ('רש"צ', 'TL', '#FFC000'),
    ('קפ"ט', 'PO', '#00B0F0'),
    ('מנהל מוצר', 'PM', '#FF0066');
...
INSERT INTO jobs.advertisements(role_id, unit_id, branch_id, department_id, job_title,job_description, entry_date, seniority, is_damach, advertiser_upn, contact, base_location_id) VALUES
	(4, 1, 1, 1,'מנהל מוצר מעגל האש', 'מנהל מוצר האש, אחראי על כלל ייצוג תהליך מעגל האש במערכת ועבודה רב"ז.', '09/20', 2, true, 's8182384', 'פלאפון 0527777780', 1),
	(3, 1, 2, 6, 'דרוש מפתח תותח','מפתח לצוות התכנון של מערכת שו"ב ל"א, פיתוח אלגוריתמי אפקטיביות חסימה למערך הל"א', '08/20', 3, true, 's8182384', 'פלאפון 0527732470', 1),
	(4, 2, 5, 13, 'מנהל מוצר מעגל','מנהל מוצר האש, אחראי על כלל ייצוג תהליך מעגל האש במערכת ועבודה רב"ז.', '04/20', 2, true, 's8258065', 'פלאפון 0527732470', 1),
	...
	(2, 2, 4, 11, 'מנהל מוצר מבצעים', 'מנהל מוצר המבצעים, עוד מוצר שהשיקו במדור עוצמה ועדיין לא מכירה ממש.', '01/21', 2, true, 's8182384', 'פלאפון 0522234560', 2),
