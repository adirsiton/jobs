...
INSERT INTO jobs.advertisements(role_id,tag_id, unit_id, branch_id, department_id, job_name,description, entry_date, seniority, is_damach, advertiser_upn, contact, base_location_id) VALUES
	...
	(2, 1, 2, 4, 10, 'רש"צ חציל', 'ראש צוות מיראז ומציאויות, הצוותים הכי טובים ביחידה BY FAR כדאי לכם להגיע!', '10/20', 2, true, 's8222765', 'פלאפון 0522234560', 2),
	(2, 2, 2, 4, 11, 'מנהל מוצר מבצעים', 'מנהל מוצר המבצעים, עוד מוצר שהשיקו במדור עוצמה ועדיין לא מכירה ממש.', '01/21', 2, true, 's8182384', 'פלאפון 0522234560', 2),
	(3, 1, 3, 6, 14, 'מנהלת מוצר מעגל','מנהל מוצר האש, אחראי על כלל ייצוג תהליך מעגל האש במערכת ועבודה רב"ז.', '11/20', 2, true, 's8258065', 'פלאפון 0522234560', 3),
	(3, 2, 3, 6, 15, 'מנהל מוצר הערכת הישג','מנהל מוצר הערכת הישג, אחראי על תהליך הערכת ההישג הצה"לי ובפרט המטכ"לי.', '05/20', 2, true, 's8222765', 'פלאפון 0528423430', 3);
